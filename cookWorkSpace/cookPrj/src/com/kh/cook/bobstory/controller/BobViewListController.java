...
@WebServlet(urlPatterns = "/bobstory/list/view")
public class BobViewListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//디비 다녀오기
		 ...
		 List<BobstoryVo> voList = new BobstoryService().selectViewList(pv);
