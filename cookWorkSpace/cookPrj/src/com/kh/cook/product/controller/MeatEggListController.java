...
@WebServlet(urlPatterns = "/product/main/meatEggList")
public class MeatEggListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		listCount = new ProductService().selectMeatEggCount();
		...
		//디비 다녀오기
		List<ProductVo> voList = new ProductService().selectMeatEggList(pv);
		
		//화면선택
		req.setAttribute("voList", voList);
		req.setAttribute("pv", pv);

		req.getRequestDispatcher("/views/product/main/meatEggList.jsp").forward(req, resp);
