...
@WebServlet(urlPatterns = "/product/main/drinkList")
public class DrinkListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		listCount = new ProductService().selectDrinkCount();
		...
		//디비 다녀오기
		List<ProductVo> voList = new ProductService().selectDrinkList(pv);
		
		//화면선택
		req.setAttribute("voList", voList);
		req.setAttribute("pv", pv);

		req.getRequestDispatcher("/views/product/main/drinkList.jsp").forward(req, resp);
