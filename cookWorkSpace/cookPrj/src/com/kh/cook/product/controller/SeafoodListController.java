...
@WebServlet(urlPatterns = "/product/main/seafoodList")
public class SeafoodListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		listCount = new ProductService().selectSeafoodCount();
		...
		//디비 다녀오기
		List<ProductVo> voList = new ProductService().selectseafoodList(pv);
		
		//화면선택
		req.setAttribute("voList", voList);
		req.setAttribute("pv", pv);

		req.getRequestDispatcher("/views/product/main/seafoodList.jsp").forward(req, resp);
