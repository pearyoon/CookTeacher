...
@WebServlet(urlPatterns = "/product/main/fruitVegeList")
public class FruitVegeListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		listCount = new ProductService().selectFruitVegeCount();
		...
		//디비 다녀오기
		List<ProductVo> voList = new ProductService().selectFruitVegeList(pv);
		
		//화면선택
		req.setAttribute("voList", voList);
		req.setAttribute("pv", pv);

		req.getRequestDispatcher("/views/product/main/fruitVegeList.jsp").forward(req, resp);
