...
@WebServlet(urlPatterns = "/product/main/etcList")
public class EtcListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		listCount = new ProductService().selectEtcCount();
		...
		req.getRequestDispatcher("/views/product/main/etcList.jsp").forward(req, resp);
