            ...
            <div id="main-bottom">
                ...
                <a id="tag-detail" >
                    <div class="main-prod-area">
                        <img src="/cookTeacher/resources/img/product/milk_big.jpg" alt="상품 이미지" width="80%" height="100%">
                    </div>
                    <br>
                    <div>
                        *제품 이미지
                ...
                <a id="tag-detail2" >
                    <br>
                    <div>
                        <img src="/cookTeacher/resources/img/product/milk_info.png" alt="상품 이미지" width="100%" height="100%">
                    </div>
                    <div>
                        *영양 정보
                        <br><br><br><br>
