   ...
   <%@include file="/views/common/header.jsp" %>
    <div id="container">
        <main>
         <hr>
            <div id="main-bottom">
            <img src="https://product-image.kurly.com/category/banner/pc/defc39cd-47b3-4eeb-86bc-b5714130975d.jpg">
                <div id="main-menu-bar">
                    ...
                    <div class="main-menu-bar-items" style="background-color: #255D00; box-shadow: 3px 3px #FFD335;">
                        <a href="/cookTeacher/product/main/drinkList" style="color: white;">음료</a>
                    </div>
                    <div class="main-menu-bar-items">
                        <a href="/cookTeacher/product/main/etcList">기타</a>
                    </div>
                </div>
               <hr><div style="font-size: 20px; font-weight: 700; ">[ 음료 ]&nbsp;&nbsp;<img src="/cookTeacher/resources/img/drink.png" style="height:4%; width:4%"></div><hr>
                <br><br>
		        ...
		        <div id="page-area">
		        	...
		        	<%if(pv.getStartPage() != 1){%>
			        	<a href="/cookTeacher/product/main/drinkList?pno=<%= pv.getStartPage()-1 %>" class="btn btn-success btn-sm">이전</a>
		        	<%}%>
		        	
		            <!-- 페이지 버튼 -->
		        	<%for(int i = pv.getStartPage(); i<= pv.getEndPage(); ++i){%>
			            <a href="/cookTeacher/product/main/drinkList?pno=<%= i %>" class="btn btn-warning btn-sm"><%= i %></a>
		        	<%}%>
		        	
		        	<!-- 다음 버튼 -->
		        	<%if(pv.getEndPage() != pv.getMaxPage()){%>
					    <a href="/cookTeacher/product/main/drinkList?pno=<%= pv.getEndPage()+1 %>" class="btn btn-success btn-sm">다음</a>
		       		<%}%>
