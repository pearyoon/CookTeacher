    ...
    <div id="container">
        ...
        <hr>
            ...
            <!-- <div>(조미료 , 양념 , 가루 , 곡식 , 견과 , 즉석제품, 김치, 기름)</div> -->
              ...
              <hr><div style="font-size: 20px; font-weight: 700; ">[ 기타 ]&nbsp;&nbsp;<img src="/cookTeacher/resources/img/seasoning.png" style="height:4%; width:4%"></div>
                <hr>
                <br><br>
		        ...
		        <div id="page-area">
		        	...
		        	<%if(pv.getStartPage() != 1){%>
			        	<a href="/cookTeacher/product/main/etcList?pno=<%= pv.getStartPage()-1 %>" class="btn btn-success btn-sm">이전</a>
		        	<%}%>
		        	
		            <!-- 페이지 버튼 -->
		        	<%for(int i = pv.getStartPage(); i<= pv.getEndPage(); ++i){%>
			            <a href="/cookTeacher/product/main/etcList?pno=<%= i %>" class="btn btn-warning btn-sm"><%= i %></a>
		        	<%}%>
		        	
		        	<!-- 다음 버튼 -->
		        	<%if(pv.getEndPage() != pv.getMaxPage()){%>
					    <a href="/cookTeacher/product/main/etcList?pno=<%= pv.getEndPage()+1 %>" class="btn btn-success btn-sm">다음</a>
		       		<%}%>
