 ...
 -->
            ...
            <div id="main-bottom">
                ...
                <div class="main-prod-area">
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/milk.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>우유 / 1.8L</div>
                    ...
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/milk2.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>유기농 우유 / 1L</div>
                    ...
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/yogurt.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                    ...
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/greekday.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                ...
                <div class="main-prod-area">
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/cheese.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>슈레드 치즈 / 210g</div>
                    ...
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/cheese2.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>어린이 치즈 / 180g</div>
                    ...
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/butter.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>무염 버터 / 200g</div>
                    ...
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/butter2.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>메이플 버터 / 150g</div>
