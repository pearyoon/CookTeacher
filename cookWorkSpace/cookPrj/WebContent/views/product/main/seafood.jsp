                ...
                <div class="main-prod-area">
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/prod_salmon.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>연어회 / 120g</div>
                    ...
                    <div>
                        <a href="/cookTeacher/views/product/detail/dairy.jsp">
                            <img src="/cookTeacher/resources/img/product/prod_squid.png" alt="식재료게시판담당" width="100%" height="100%">
                        </a>
                        <div>오징어 / 1kg</div>
