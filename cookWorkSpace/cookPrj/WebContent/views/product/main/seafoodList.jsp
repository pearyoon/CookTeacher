   ...
   <%@include file="/views/common/header.jsp" %>
    <div id="container">
        <main>
            <hr>
            <div id="main-bottom">
            <img src="https://product-image.kurly.com/category/banner/pc/8afb991b-a88c-44be-9260-cfce550b55c9.jpg"><br>
            <!-- <div id="main-title">해산물</div> -->
		        ...
		        <div id="page-area">
		        	...
		        	<%if(pv.getStartPage() != 1){%>
			        	<a href="/cookTeacher/product/main/seafoodList?pno=<%= pv.getStartPage()-1 %>" class="btn btn-success btn-sm">이전</a>
		        	<%}%>
		        	
		            <!-- 페이지 버튼 -->
		        	<%for(int i = pv.getStartPage(); i<= pv.getEndPage(); ++i){%>
			            <a href="/cookTeacher/product/main/seafoodList?pno=<%= i %>" class="btn btn-warning btn-sm"><%= i %></a>
		        	<%}%>
		        	
		        	<!-- 다음 버튼 -->
		        	<%if(pv.getEndPage() != pv.getMaxPage()){%>
					    <a href="/cookTeacher/product/main/seafoodList?pno=<%= pv.getEndPage()+1 %>" class="btn btn-success btn-sm">다음</a>
		       		<%}%>
