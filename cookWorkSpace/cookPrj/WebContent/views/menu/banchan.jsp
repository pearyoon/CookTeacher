...
<link rel="stylesheet" href="/cookTeacher/resources/css/menu/banchan.css">
...
<body>
    ...
    <div id="container">
        <main>
            ...
            <div id="recipe-banchan">
                <div id="resipe" >|&nbsp;&nbsp; 반찬 &nbsp;&nbsp;|</div>
                <hr width="60%" style="margin-bottom: 10px; margin-top: 10px;">
                <div id="ment"><label for="">쿡선생과 함께라면 반찬 요리도 뚝딱!</label></div>
                    
                    <div id="gap"></div>
                    <hr width="60%" style="margin-bottom: 10px; margin-top: 10px;">
                
                    <div class="recipe-banchan-area">
                    <div>
                        ...
                        <a href="">
	                        ...
	                        <div class="banchan-name">김치찌개</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
	                        ...
	                        <div class="banchan-name">김치볶음밥</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
	                        ...
	                        <div class="banchan-name">갈치조림</div>
                        </a>
                    </div>
                ...
                <div class="recipe-banchan-area">
                    <div>
                        ...
                        <a href="">
	                        ...
	                        <div class="banchan-name">된장찌개</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
	                        ...
	                        <div class="banchan-name">매콤 돼지 갈비찜</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
