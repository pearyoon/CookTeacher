       ...
       <div id="container">
            ...
            <div id="recipe-middle">
                ...
                <hr width="60%" style="margin-top: 10px; margin-bottom: 50px">
                    ...
                    <div>
                        <a href="/cookTeacher/menu/detail?no=1">
                            <img src="/cookTeacher/resources/img/한식레시피/kimchi_stew.png" alt="레시피게시판담당" width="100%" height="100%">
                        </a>
                    ...
                    <div>
                        <a href="/cookTeacher/menu/detail?no=5">
                            <img src="/cookTeacher/resources/img/한식레시피/stewed_tofu.png" alt="레시피게시판담당" width="100%" height="100%">
                        </a>
                        <div class="re-title">두부조림</div>
                        <div class="re-ment">흰 쌀밥이 생각나는 맛도 좋고 영양가도 좋은 최고의 반찬</div>
                    </div>
                    <div>
                        <a href="/cookTeacher/menu/detail?no=9">
                ...
                <div class="recipe-menu-area">
                <div>
                    <a href="/cookTeacher/menu/detail?no=11">
                        <img src="/cookTeacher/resources/img/banchan/sausageyachaebokkeum.PNG" alt="레시피게시판담당" width="100%" height="100%">
                    </a>
                    <div class="re-title">소세지 야채볶음</div>
                    <div class="re-ment">어른아이 할것없이 다 좋아하는 만능 반찬</div>
                </div>
                <div>
                    <a href="/cookTeacher/menu/detail?no=20">
                        <img src="/cookTeacher/resources/img/myulchibokkeum.PNG" alt="레시피게시판담당" width="100%" height="100%">
                    </a>
                    <div class="re-title">메추리알스팸조림</div>
                    <div class="re-ment">아이반찬 걱정 뚝! 10분반찬 메추리알조림</div>
                </div>
                <div>
                    <a href="/cookTeacher/menu/detail?no=15">
                        <img src="/cookTeacher/resources/img/kongnamulmuchim.PNG" alt="레시피게시판담당"  width="100%" height="100%">
                    </a>
                ...
                <!-- ------- -->
                <div class="cate-name"><a href="/cookTeacher/views/menu/westren.jsp">< 일식 ></a></div>
                <div class="recipe-menu-area">
                <div>
                    <a href="/cookTeacher/menu/detail?no=21">
                        <img src="/cookTeacher/resources/img/일식 레시피 이미지/일식계란말이.jpg" alt="레시피게시판담당" width="100%" height="100%">
                    </a>
                    <div class="re-title">일식 계란말이</div>
                    <div class="re-ment">달달하고 부드러운 계란말이! 밥 반찬으로 뚝딱!</div>
                </div>
                <div>
                    <a href="/cookTeacher/menu/detail?no=27">
                ...
                <div>
                    <a href="/cookTeacher/menu/detail?no=29">
                        <img src="/cookTeacher/resources/img/일식 레시피 이미지/밀푀유나베.jpg"  alt="레시피게시판담당"  width="100%" height="100%">
                    </a>
                ...
                <div class="recipe-menu-area">
                <div>
                    <a href="/cookTeacher/menu/detail?no=31">
                        <img src="/cookTeacher/resources/img/jjambbong.jpg" alt="레시피게시판담당" width="100%" height="100%">
                    </a>
                    <div class="re-title">짬뽕</div>
                    <div class="re-ment">깔끔하고 얼큰하고 시원한 국물 맛이 일품인 짬뽕</div>
                </div>
                <div>
                    <a href="/cookTeacher/menu/detail?no=32">
                ...
                <div>
                    <a href="/cookTeacher/menu/detail?no=33">
                ...
                <div class="cate-name"><a href="/cookTeacher/views/menu/japanese.jsp">< 양식 ></a></div>
                <div class="recipe-menu-area">
                <div>
                    <a href="/cookTeacher/menu/detail?no=41">
                ...
                <div>
                    <a href="/cookTeacher/menu/detail?no=44">
                        <img src="/cookTeacher/resources/img/양식레시피/양송이스프.jpg " alt="레시피게시판담당" width="100%" height="100%">
                    </a>
                    <div class="re-title">양송이스프</div>
                    <div class="re-ment">반찬으로도, 간단한 아침식사로도, 에피타이저로도 좋은 양송이 스프 </div>
                </div>
                <div>
                    <a href="/cookTeacher/menu/detail?no=47">
                        <img src="/cookTeacher/resources/img/양식레시피/감바스.jpg" alt="레시피게시판담당"  width="100%" height="100%">
                    </a>
                ...
                <div class="recipe-menu-area">
                <div>
                    <a href="/cookTeacher/menu/detail?no=51">
                        <img src="/cookTeacher/resources/img/디저트레시피/바나나크레페.jpg" alt="레시피게시판담당" width="100%" height="100%">
                    </a>
                    <div class="re-title">바나나크레페</div>
                    <div class="re-ment">바나나를 넣어 든든하며 주말 브런치로 맛있게 즐길 수 있는 바나나크레페!</div>
                </div>
                <div>
                    <a href="/cookTeacher/menu/detail?no=59">
                ...
                <div>
                    <a href="/cookTeacher/menu/detail?no=56">
