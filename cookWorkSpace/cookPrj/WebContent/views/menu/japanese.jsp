...
<link rel="stylesheet" href="/cookTeacher/resources/css/menu/japanese.css">
...
<body>
    ...
    <div id="container">
        <main>
            ...
            <div id="recipe-japanese">
                <div id="resipe" >|&nbsp;&nbsp; 일식 &nbsp;&nbsp;|</div>
                <hr width="60%" style="margin-bottom: 10px; margin-top: 10px;">
                <div id="ment"><label for="">쿡선생과 함께라면 비행기 없이도 여기가 일본 ! </label></div>
                    
                    <div id="gap"></div>
                    <hr width="60%" style="margin-bottom: 10px; margin-top: 10px;">
                
                    <div class="recipe-japanese-area">
                    <div>
                        ...
                        <a href="">
	                        ...
	                        <div class="japanese-name">김치찌개</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
	                        ...
	                        <div id="ment-detail">
	                            한 끼 식사로 간단하게 뚝딱 만들어 먹는 음식
	                        </div>
	                        <div class="japanese-name">김치볶음밥</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
	                        ...
	                        <div class="japanese-name">갈치조림</div>
                        </a>
                    </div>
                ...
                <div class="recipe-japanese-area">
                    <div>
                        ...
                        <a href="">
	                        ...
	                        <div class="japanese-name">된장찌개</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
	                        ...
	                        <div class="japanese-name">매콤 돼지 갈비찜</div>
                        </a>
                    </div>
                    <div>
                        <a href="">
